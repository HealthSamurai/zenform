...
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var pred__26659 = cljs.core.instance_QMARK_;
var expr__26660 = reactive_val;
if(cljs.core.truth_((pred__26659.cljs$core$IFn$_invoke$arity$2 ? pred__26659.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__26660) : pred__26659.call(null,reagent.ratom.RAtom,expr__26660)))){
return "ra";
} else {
if(cljs.core.truth_((pred__26659.cljs$core$IFn$_invoke$arity$2 ? pred__26659.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__26660) : pred__26659.call(null,reagent.ratom.RCursor,expr__26660)))){
return "rc";
} else {
if(cljs.core.truth_((pred__26659.cljs$core$IFn$_invoke$arity$2 ? pred__26659.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__26660) : pred__26659.call(null,reagent.ratom.Reaction,expr__26660)))){
return "rx";
} else {
if(cljs.core.truth_((pred__26659.cljs$core$IFn$_invoke$arity$2 ? pred__26659.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__26660) : pred__26659.call(null,reagent.ratom.Track,expr__26660)))){
return "tr";
} else {
return "other";
}
